...
.PHONY: clean
clean:
	rm -rf $(trace_object) $(server_object) $(client_object) $(bin_client) $(bin_server) $(b_parse_object) $(bin_b_parse) $(torrent_parse_object) $(bin_torrent_parse) $(peer_message_object) $(bin_peer_message) $(SRC)/b_parse.a
